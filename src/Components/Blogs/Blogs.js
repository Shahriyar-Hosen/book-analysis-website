      ...
      <div className="grid grid-cols-1 gap-10 my-10">
        ...
        <div>
          <div className="w-full md:w-[600px] mx-auto shadow-lg shadow-gray-500 rounded-2xl  bg-cyan-100 p-4">
            ...
            <p className="text-md font-serif p-5">
              {`ব্লক এলিমেন্ট 
            যে ট্যাগগুলো নতুন লাইন তৈরি করে তাদেরকে ব্লক এলিমেন্ট বলে। অর্থাৎ যে ট্যাগগুলো ব্রাউজারের পুরো প্রস্থ নেয় তাদেরকে ব্লক এলিমেন্ট বলে যেমনঃ-div, p, h1-h6,section…. ইনলাইন এলিমেন্ট 
            যে ট্যাগগুলো একই লাইনে থাকে তাদেরকে ইনলাইন এলিমেন্ট বলে। অর্থাৎ যে এলিমেন্ট গুলো নতুন কোন লাইন তৈরি করে না যেই লাইনে দেওয়া হয় সেই লাইনের ভেতরেই বসে যায় তাদেরকে ইনলাইন এলিমেন্ট বলে। যেমনঃ- <span />, <small />, <a href=""></a>`}
            </p> 
          </div>
        </div>
      </div>
